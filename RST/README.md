...
[![Build status](https://travis-ci.org/reStructuredText/RST.svg?branch=master)](https://travis-ci.org/reStructuredText/RST)
...
$parser = new reStructuredText\RST\Parser;
...
Where can I get it?
-------------------
You can get it on the `GitHub page <https://github.com/reStructuredText/RST>`_
';
...
<p>You can get it on the <a href="https://github.com/reStructuredText/RST">GitHub page</a></p>
*/
```
...
$builder = new reStructuredText\RST\Builder;
...
Write your own class that extends the `reStructuredText\RST\Directive` class, and define the
