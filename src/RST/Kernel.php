...
namespace TechnoBureau\reStructuredText\RST;

use TechnoBureau\reStructuredText\RST\Builder;
use TechnoBureau\reStructuredText\RST\Document;
use TechnoBureau\reStructuredText\RST\HTML\Directives\Image;
abstract class Kernel
{
    ...
    {
        return 'TechnoBureau\reStructuredText\RST\\'.$this->getName().'\\'.$name;
    }
